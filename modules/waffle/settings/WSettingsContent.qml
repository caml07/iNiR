...
Item {
    ...
    property var searchIndex: [
        ...
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Minimum quiet time", targetLabel: "Minimum quiet time", keywords: ["mascot", "quiet", "cooldown", "minutes", "frequency", "interrupt"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Maximum visits per hour", targetLabel: "Maximum visits per hour", keywords: ["mascot", "visits", "hour", "rate", "limit", "frequency"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Respect Do Not Disturb and quiet hours", targetLabel: "Respect Do Not Disturb and quiet hours", keywords: ["mascot", "dnd", "quiet", "notifications", "focus", "suppress"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "React to opened shell panels", targetLabel: "React to opened shell panels", keywords: ["mascot", "panels", "shell", "react", "sidebar", "overview", "search"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Speech bubbles", targetLabel: "Speech bubbles", keywords: ["mascot", "dialogue", "speech", "bubble", "text", "talk"] },
        ...
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Character art", targetLabel: "Character art", keywords: ["mascot", "kira", "jrpg", "codex", "classic", "style", "sprites"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Minimum time between chaos visits", targetLabel: "Minimum time between chaos visits", keywords: ["mascot", "chaos", "interval", "frequency", "minutes"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Calling-card notifications", targetLabel: "Calling-card notifications", keywords: ["mascot", "chaos", "calling", "card", "notification", "prank"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Play chase", targetLabel: "Play chase", keywords: ["mascot", "chase", "mouse", "game", "play"] },
        { pageIndex: 14, pageName: "Mascot", section: "Mascot", label: "Hide and seek", targetLabel: "Hide and seek", keywords: ["mascot", "hide", "seek", "game", "find", "timer"] },
        ...
        { pageIndex: 1, pageName: "General", section: "Game Mode", label: "Disable audio visualizers", targetLabel: "Disable audio visualizers", keywords: ["game", "gaming", "cava", "visualizer", "spectrum", "audio", "performance"] },
