...
declare -gA IPC_TARGET_FUNCTIONS=(
  ...
  [iris]="open page close toggle card settings bubble dock dockApp appBubble pin layout barPiece arrange studio notch surround accent spotlight bubbleCard bubbleMenu morph preset utility status"
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["iris:settings"]="Open iRiS Settings on a section: \`bar\`, \`player\`, \`bubbles\`, \`dock\`, \`appearance\`, \`desktop\`, \`sidebars\`, \`surfaces\` or \`system\`; add \`/<group>\` to scroll to a group, e.g. \`bubbles/behaviour\`"
  ...
  ["iris:morph"]="Set how iRiS morphs: \`liquid\`, \`glide\`, \`snap\`, \`elastic\` or \`instant\`"
  ["iris:preset"]="Set the iRiS appearance preset: \`iris\`, \`soft\`, \`crisp\` or \`contrast\`"
